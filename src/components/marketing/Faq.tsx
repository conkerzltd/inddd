...
const Faq = () => {
  ...
  const items = isAr
    ? [
        { q: "هل inddd تطبيق حجز؟", a: "لا. نركز على يوم العيادة ورؤية الطابور المباشر، مش الحجوزات." },
        { q: "إزاي المرضى بيستلموا الرابط؟", a: "العيادة بترسل رابط واتساب بعد الحجز أو عند الحضور." },
        { q: "هل فتح الرابط بيسجل حضور المريض؟", a: "لا. فتح الرابط بيعرض الطابور المباشر بس. العيادة بتأكد الحضور." },
        { q: "هل ينفع مع الحضور المباشر؟", a: "أيوه. الحضور المباشر بيتضاف لنفس الطابور مع الحجوزات." },
        ...
        { q: "إيه اللي بيحصل لما مريض يتأخر؟", a: "المتأخرين ممكن يتأجلوا، والطابور يفضل عادل وشفاف." },
        { q: "هل العيادة تقدر توقف الاستقبال؟", a: "أيوه. الاستقبال يتوقف بدون ما الطابور الحالي يتأثر." },
