CREATE OR REPLACE FUNCTION public.onboard_clinic(p_name_ar text, p_primary_specialty_id uuid DEFAULT NULL, p_governorate_ar text DEFAULT 'placeholder', p_locality_level2_ar text DEFAULT 'placeholder', p_locality_level2_type text DEFAULT 'CITY'::text, p_locality_level3_ar text DEFAULT NULL::text, p_phone text DEFAULT NULL::text, p_marketer_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
