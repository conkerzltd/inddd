...
BEGIN
  ...
  -- Unified ETA computation for waiting statuses
  IF v_ticket.status IN ('REMOTE_BOOKED', 'LINK_SENT', 'INSIDE_WAITING') THEN

    -- Compute hypothetical rank_key for this ticket
    ...
    -- For BOOKED/LINK_SENT, compute inside-clinic position
    ...
    -- Count pre-arrival tickets ahead
