...
if [ -n "$CODESPACE_NAME" ]; then
    ...
    echo ""
    echo "2. If you see 'has been deleted or you do not have permission':"
    echo "   - VS Code is trying to connect to an OLD/DELETED codespace"
    echo "   - See: docs/DELETED_CODESPACE_FIX.md"
    echo "   - Quick fix: Clear VS Code cache and reconnect to the NEW codespace"
    echo "   - Windows: Delete %APPDATA%\\Code\\User\\globalStorage\\github.codespaces"
    echo "   - Mac: Delete ~/Library/Application Support/Code/User/globalStorage/github.codespaces"
    echo "   - Linux: Delete ~/.config/Code/User/globalStorage/github.codespaces"
    echo ""
    echo "3. If connection repeatedly fails:"
    ...
    echo ""
    echo "4. If using VS Code Desktop:"
